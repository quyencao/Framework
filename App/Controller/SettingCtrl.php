...
use App\View\Setting\StringControl;
use App\View\Setting\BooleanControl;
use App\View\Setting\SelectControl;
use App\View\Setting\TextControl;
use Lib\Setting;

class SettingCtrl extends CoreCtrl {
